...
export const tasks: Task[] = [
  {
    ...
    dueDate: daysAgo(2), notes: 'Design main event poster and social media variants',
  ...
  },
  {
    ...
    dueDate: daysAgo(1), notes: 'Confirm auditorium booking for June 20th',
  ...
  },
  {
    ...
    dueDate: daysFromNow(2), notes: 'Confirm availability of guest speakers',
  ...
  },
  {
    ...
    dueDate: daysFromNow(3), notes: 'Set up and manage registration system',
  ...
  },
  {
    ...
    dueDate: daysFromNow(5), notes: 'Draft event promotion posts for LinkedIn',
  ...
  },
  {
    ...
    dueDate: daysFromNow(7), notes: 'Create presentation for the event',
  ...
  },
  {
    ...
    dueDate: daysFromNow(4), notes: 'Create WhatsApp broadcast messages',
  ...
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Cover all key moments during the event',
  ...
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Manage stage schedule and speaker flow',
    completionPercentage: 0, createdAt: daysAgo(6), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Prepare script and host the event',
  ...
  },
  {
    ...
    dueDate: daysAgo(3), notes: 'Assign volunteers for event day duties',
  ...
  },
  {
    ...
    dueDate: daysFromNow(1), notes: 'Design event banners and flex materials',
  ...
  },
  {
    ...
    dueDate: daysAgo(4), notes: 'Prepare OD letters for attendees',
  ...
  },
  {
    ...
    dueDate: daysAgo(1), notes: 'Create Instagram posts and stories',
  ...
  },
  {
    ...
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(6), notes: 'Draft event announcement email',
  ...
  },
  {
    ...
    dueDate: daysFromNow(3), notes: 'Schedule promotional posts across platforms',
  ...
  },
  {
    ...
    dueDate: daysFromNow(8), notes: 'Design e-certificate template',
    completionPercentage: 0, createdAt: daysAgo(2), completedAt: null, updatedAt: daysAgo(2),
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Manage attendee check-in at registration desk',
  ...
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Ensure AV equipment and presentations work',
    completionPercentage: 0, createdAt: daysAgo(7), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    id: 't20', name: 'E-Certificate Generation', category: 'post_event', priority: 'high',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(15), notes: 'Generate e-certificates for all participants',
    completionPercentage: 0, createdAt: daysAgo(1), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    id: 't21', name: 'Event Report Generation', category: 'post_event', priority: 'medium',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(17), notes: 'Compile comprehensive event report',
    completionPercentage: 0, createdAt: daysAgo(1), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    id: 't22', name: 'Feedback Collection', category: 'post_event', priority: 'medium',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(14), notes: 'Create and distribute feedback forms',
  ...
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Post real-time updates during the event',
    completionPercentage: 0, createdAt: daysAgo(6), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Manage presentation transitions on stage',
  ...
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Ensure orderly crowd movement',
  ...
  },
  {
    ...
    status: 'yet_to_start', assignedTo: crewMembers[2], assignedBy: crewMembers[5],
    dueDate: daysFromNow(6), notes: 'Send reminder to registered participants',
    completionPercentage: 0, createdAt: daysAgo(3), completedAt: null, updatedAt: daysAgo(3),
  },
  {
    ...
    dueDate: daysFromNow(10), notes: 'Track and record attendee attendance',
    completionPercentage: 0, createdAt: daysAgo(6), completedAt: null, updatedAt: daysAgo(1),
  },
  {
    ...
    dueDate: daysFromNow(11), notes: 'Draft initial event report during the event',
  ...
  },
  {
    ...
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(12), notes: 'Design post-event highlight posters',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't30', name: 'LinkedIn Post', category: 'post_event', priority: 'high',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(13), notes: 'Write and publish event recap on LinkedIn',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't31', name: 'Instagram Highlights', category: 'post_event', priority: 'medium',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(13), notes: 'Create Instagram highlight reels',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't32', name: 'WhatsApp Thank You Message', category: 'post_event', priority: 'low',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(12), notes: 'Send thank you message to participants',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't33', name: 'OD Report Generation', category: 'post_event', priority: 'high',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(16), notes: 'Generate OD report for attendees',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't34', name: 'Media Archive Management', category: 'post_event', priority: 'low',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(18), notes: 'Organize and archive all event media',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't35', name: 'Attendance Consolidation', category: 'post_event', priority: 'medium',
    status: 'not_assigned', assignedTo: null, assignedBy: null,
    dueDate: daysFromNow(16), notes: 'Compile final attendance records',
    completionPercentage: 0, createdAt: daysAgo(0), completedAt: null, updatedAt: daysAgo(0),
  },
  {
    id: 't36', name: 'Guest Management', category: 'during_event', priority: 'critical',
    status: 'assigned', assignedTo: crewMembers[5], assignedBy: crewMembers[3],
    dueDate: daysFromNow(10), notes: 'Coordinate guest arrival and seating',
  ...
  },
  {
    ...
    status: 'assigned', assignedTo: crewMembers[7], assignedBy: crewMembers[5],
    dueDate: daysFromNow(10), notes: 'Record key sessions and highlights',
    completionPercentage: 0, createdAt: daysAgo(6), completedAt: null, updatedAt: daysAgo(1),
  },
];
